...
CREATE TABLE search (
    ...
    map_id INTEGER REFERENCES map(map_id) ON DELETE SET NULL,
    boat_id INTEGER REFERENCES boat(boat_id) ON DELETE SET NULL,
...
INSERT INTO person (name, surname, age, gender, nationality, location_id) VALUES ('Ivan', 'Ivanov', 10, 'male', 'Russian', 1);
INSERT INTO person (name, surname, age, gender, nationality, location_id) VALUES ('Petr', 'Petrov', 18, 'male', 'Russian', 3);
...
INSERT INTO search (description, type_of_search, box_id, person_id) VALUES ('Ищу ящик с id = 1', 'box', 1, 3);

INSERT INTO spider (size, type, danger_category, location_id) VALUES (4, 'Большой павук с размером с длинным пальцем', 'high', 3);